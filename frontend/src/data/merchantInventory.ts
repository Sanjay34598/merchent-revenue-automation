...
const REAL_PRODUCTS_SEED: Array<{
  ...
  { sku: 'PROD-100043', name: 'Boot Plushfoot', division: 'Femme Footwear', category: 'Femme Footwear Boot Collection', supplier: 'Vendor 0064', price: 151.58, cost: 64.94, stock: 84, velocity: 0.8, risk: 'SLOW_MOVING', action: 'Review markdown strategy' },
  { sku: 'PROD-100128', name: 'Derby Classic Black', division: 'Scholar Footwear', category: 'Scholar Footwear Derby Classic', supplier: 'Vendor 0012', price: 120.00, cost: 55.00, stock: 12, velocity: 4.5, risk: 'STOCKOUT', action: 'Replenish 25 units' },
  { sku: 'PROD-100342', name: 'Denim Essentials Indigo', division: 'Junior Apparel', category: 'Junior Apparel Denim Essentials', supplier: 'Vendor 0089', price: 85.00, cost: 68.00, stock: 140, velocity: 1.2, risk: 'MARGIN_LEAK', action: 'Review pricing & supplier cost' },
  { sku: 'PROD-100512', name: 'Sandal Studio Strap Gold', division: 'Femme Footwear', category: 'Femme Footwear Sandal Studio', supplier: 'Vendor 0045', price: 195.00, cost: 88.00, stock: 160, velocity: 0.5, risk: 'OVERSTOCK', action: 'Move excess inventory across stores' },
  { sku: 'PROD-100680', name: 'School Trainer White', division: 'Scholar Footwear', category: 'Scholar Footwear School Trainer', supplier: 'Vendor 0012', price: 110.00, cost: 48.00, stock: 45, velocity: 3.2, risk: 'HEALTHY', action: 'Maintain Stock' },
  { sku: 'PROD-100791', name: 'Sport Active Hoodie', division: 'Junior Apparel', category: 'Junior Apparel Sport Active', supplier: 'Vendor 0089', price: 75.00, cost: 32.00, stock: 95, velocity: 0.6, risk: 'SLOW_MOVING', action: 'Review markdown strategy' },
  { sku: 'PROD-100844', name: 'Stiletto Elegance Velvet', division: 'Femme Footwear', category: 'Femme Footwear Stiletto Elegance', supplier: 'Vendor 0064', price: 240.00, cost: 110.00, stock: 8, velocity: 2.8, risk: 'STOCKOUT', action: 'Replenish 18 units' },
  { sku: 'PROD-100915', name: 'Slip-on Oxford Tan', division: 'Scholar Footwear', category: 'Scholar Footwear Slip-on Oxford', supplier: 'Vendor 0012', price: 135.00, cost: 62.00, stock: 52, velocity: 2.1, risk: 'HEALTHY', action: 'Maintain Stock' },
  { sku: 'PROD-101030', name: 'Winter Knitwear Sweater', division: 'Junior Apparel', category: 'Junior Apparel Winter Knitwear', supplier: 'Vendor 0089', price: 92.00, cost: 74.00, stock: 110, velocity: 0.4, risk: 'MARGIN_LEAK', action: 'Review pricing & supplier cost' },
  { sku: 'PROD-101182', name: 'Ballet Flat Nude', division: 'Femme Footwear', category: 'Femme Footwear Ballet Flat', supplier: 'Vendor 0045', price: 125.00, cost: 52.00, stock: 38, velocity: 1.8, risk: 'HEALTHY', action: 'Maintain Stock' },
  { sku: 'PROD-101294', name: 'Casual Sneaker Court', division: 'Scholar Footwear', category: 'Scholar Footwear Casual Sneaker', supplier: 'Vendor 0012', price: 145.00, cost: 65.00, stock: 130, velocity: 0.9, risk: 'OVERSTOCK', action: 'Move excess inventory across stores' },
  { sku: 'PROD-101350', name: 'Summer Graphic Tee Pack', division: 'Junior Apparel', category: 'Junior Apparel Summer Graphic Tee', supplier: 'Vendor 0089', price: 45.00, cost: 18.00, stock: 64, velocity: 3.5, risk: 'HEALTHY', action: 'Maintain Stock' },
];
